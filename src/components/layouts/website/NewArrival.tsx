    ...
    <div className="w-full">
      ...
      <div className="mt-10 flex items-center justify-between">
        <h2 className="text-3xl font-bold ">
          New Arrival
          <span
            className="bg-[#EFEFEF] text-[#888888] 
          text-[20px] inline-block w-50
           py-4 mx-5 text-center  rounded-4xl 
           font-medium  "
          >
            30 products
          </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center rounded-md border overflow-hidden">
            <button type="button" className="p-1.5" aria-label="Grid view">
              <Grid2X2 size={32} />
            </button>
            <button type="button" className="p-1.5" aria-label="List view">
              <List size={32} />
            </button>
          </div>
        </div>
